...
class RetrievalService:
    ...
    def index_candidates(self, candidates: List[Dict[str, Any]]) -> None:
        ...
        self.index_manager.add_vectors(embeddings_np, candidate_ids)
    ...
    def search_candidates(self, job_description_text: str, top_k: int = 100) -> List[Dict[str, Any]]:
        ...
        results_ids, scores = self.index_manager.search(jd_embedding, top_k=top_k)

        output = []
        for candidate_id, score in zip(results_ids, scores):
